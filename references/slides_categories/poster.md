...
Review the user's assets, actual image candidates, and the fonts available in `design.md` §4 before finalizing `style.md`. Keep the content short, specific, and actionable; it typically includes:
