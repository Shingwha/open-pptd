...
| `isolation/` | 逐组件隔离（14 页） | 弹修复定位：`node tests/isolate.mjs` 逐页导出 iso-NN.pptx；09/10/11 页已扩展为 187 形状/曲线/裁剪 |
| `shapes/` | shape 全量（187 预置 + 自定义路径，8 页） | 阶段 C1：预置几何全量 + a:custGeom（官方镂空/贝塞尔/相对命令/旋转弧）专项 |
